...
class Paint:
    def __init__(self, top=None):
        ...
        self.right_triangle.bind('<Button-1>',lambda e:Main_GUI_support.creat_right_tri(top))
        ...
        self.ellipse.bind('<Button-1>',lambda e:Main_GUI_support.creat_ellipse(top))
        ...
        #self.polygon.bind('<Button-1>',lambda e:Main_GUI_support.creat_poligon(root, data, canvas))
        ...
        #self.shape_c.bind('<Button-1>',lambda e:Main_GUI_support.click(event))
