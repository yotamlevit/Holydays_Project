...
def vp_start_gui():
    ...
    global val, w, root
    root = Tk()
    top = Creat_Rectangle (root)
    root.mainloop()

w = None
def create_Creat_Rectangle(root, data_obj, canvas, shape=None, *args, **kwargs):
    '''Starting point when module is imported by another program.'''
    global w, w_win, rt
    rt = root
    w = Toplevel(root)
    top = Creat_Rectangle(data_obj, canvas, shape, w)
    return (w, top)

def destroy_Creat_Rectangle():
    global w
    w.destroy()
    w = None


class Creat_Rectangle:
    def __init__(self, data_obj, canvas, shape, top=None):
        ...
        if shape is None:
            top.title("Creat Rectangle")
        else:
            top.title("Mode Rectangle")
        ...
        self.txt_Creat_Rectangle = Label(top)
        self.txt_Creat_Rectangle.place(relx=0.032, rely=0.0, height=41
                , width=134)
        self.txt_Creat_Rectangle.configure(activebackground="#f9f9f9")
        self.txt_Creat_Rectangle.configure(activeforeground="black")
        self.txt_Creat_Rectangle.configure(background="#d9d9d9")
        self.txt_Creat_Rectangle.configure(disabledforeground="#a3a3a3")
        self.txt_Creat_Rectangle.configure(foreground="#000000")
        self.txt_Creat_Rectangle.configure(highlightbackground="#d9d9d9")
        self.txt_Creat_Rectangle.configure(highlightcolor="black")
        self.txt_Creat_Rectangle.configure(text='''Creat Right Triangle''')
        ...
        if shape is None:
            ...
            self.txt_Creat_Rectangle.configure(text='''Mode Rectangle''')
    ...
    def button_pres(self):
        ...
        if x.isdigit() and y.isdigit() and side1.isdigit() and side2.isdigit() and color is not "" and color in COLORS and line in COLORS and int(x) < 1001 and int(y) < 916:
            ...
            obj = [Rectangle(int(x), int(y), int(side1), int(side2), color, line),[int(x), int(y), int(side1), int(side2), color, line]]
            obj_val = obj[0].draw_me(self.canv)
            self.data.set_value(obj_val, obj)
            destroy_Creat_Rectangle()
        else:
            self.txt_Creat_Rectangle.configure(text="invalid values")
